package kr.startoff.backend.domain.meetingroom.service;
...
import kr.startoff.backend.domain.meetingroom.domain.MeetingRoom;
import kr.startoff.backend.domain.meetingroom.repository.MeetingRoomRepository;
