package kr.startoff.backend.common.security.oauth2;
...
import kr.startoff.backend.common.security.oauth2.user.OAuth2UserInfoFactory;
import kr.startoff.backend.domain.user.domain.AuthProvider;
import kr.startoff.backend.domain.user.domain.User;
import kr.startoff.backend.common.exception.custom.OAuth2AuthenticationProcessingException;
import kr.startoff.backend.domain.user.repository.UserRepository;
import kr.startoff.backend.common.security.UserPrincipal;
import kr.startoff.backend.common.security.oauth2.user.OAuth2UserInfo;
